  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className="hidden md:flex gap-4 md:w-1/3 justify-center">
        <Link target="_blank" href="https://github.com/MuhammadArbazUddin">
          <Image
            src="/github.png"
            alt="Github Icon"
            width={24}
            height={24}
            className="animate-bounce transition-all duration-75"
          />
        </Link>

        <Link target="_blank" href="https://www.linkedin.com/in/arbaz-uddin/">
          <Image
            src="/linkedin.png"
            alt="Linkedin Icon"
            width={24}
