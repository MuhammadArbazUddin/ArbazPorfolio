        ...
        <div className="flex flex-col md:flex-row md:justify-center gap-8 text-center font-semibold">
          {project.liveLink && (
            <Link
              ...
              className="p-2 md:p-4 bg-gradient-to-r from-purple-500 to-orange-200 shadow-md rounded text-white uppercase"
            >
              SEE LIVE
            </Link>
          )}
          {project.codeLink && (
            <Link
              ...
              className="p-2 md:p-4 bg-white shadow-md rounded text-black uppercase"
            >
              SEE CODE
            </Link>
          )}
